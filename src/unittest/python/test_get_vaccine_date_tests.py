...
class TestGetVaccineDate(TestCase):
    ...
    @freeze_time("2022-03-08")
    def test_get_vaccine_date_menor(self):
        """test donde la fecha introducida es menor a la actual"""
        file_test = JSON_FILES_RF2_PATH + "test_ok.json"
        my_manager = VaccineManager()
        ...
        with self.assertRaises(VaccineManagementException) as c_m:
            my_date = "2022-03-07"
            my_manager.get_vaccine_date(file_test, my_date)
        self.assertEqual(c_m.exception.message, "La fecha no es valida")

    @freeze_time("2022-03-08")
    def test_get_vaccine_date_igual(self):
        """test donde la fecha introducida es igual a la actual"""
        file_test = JSON_FILES_RF2_PATH + "test_ok.json"
        my_manager = VaccineManager()
    ...
    @freeze_time("2022-03-08")
    def test_get_vaccine_date_mayor(self):
        """test ok, donde la fecha introducida es mayor a la actual"""
        file_test = JSON_FILES_RF2_PATH + "test_ok.json"
        my_manager = VaccineManager()
        my_date = "2022-03-09"
    ...
    @freeze_time("2022-03-08")
    def test_get_vaccine_date_bad_format(self):
        """test donde la fecha introducida es igual a la actual"""
        file_test = JSON_FILES_RF2_PATH + "test_ok.json"
        my_manager = VaccineManager()
        ...
        with self.assertRaises(VaccineManagementException) as c_m:
            my_date = "204-23-08"
            my_manager.get_vaccine_date(file_test, my_date)
        self.assertEqual(c_m.exception.message, "El formato de la fecha no es valido")
