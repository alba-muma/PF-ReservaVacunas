...
class PatientsJsonStore(JsonStore):
    ...
    def __new__(cls):
        if not PatientsJsonStore.__instance:
            PatientsJsonStore.__instance = PatientsJsonStore.__PatientsJsonStore()
        return PatientsJsonStore.__instance
