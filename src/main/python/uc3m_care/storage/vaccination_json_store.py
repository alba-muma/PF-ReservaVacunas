...
class VaccinationJsonStore(JsonStore):
    ...
    __instance = None
    def __new__(cls):
        if not VaccinationJsonStore.__instance:
            VaccinationJsonStore.__instance = VaccinationJsonStore.__VaccinationJsonStore()
        return VaccinationJsonStore.__instance
