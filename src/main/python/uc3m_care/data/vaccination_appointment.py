...
from uc3m_care.data.attribute.attribute_date_appointment import DateAppointment
...
class VaccinationAppointment():
    ...
    def __init__(self, patient_sys_id, patient_phone_number, patient_date_appointment):
        self.__alg = "SHA-256"
        self.__type = "DS"
        self.__isCancel = "Vigente"
        self.__appointment_date = DateAppointment(patient_date_appointment).value
    ...
    def appointment_date(self, value):
        self.__appointment_date = DateAppointment(value).value
    ...
    def is_valid_today(self):
        ...
        date_float = datetime.strptime(self.__appointment_date, "%Y-%m-%d")
